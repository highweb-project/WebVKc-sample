    ...
    var API = {
        ...
        initEnv : function(){
            ...
            try {
                ...
                document.getElementById('btVK').addEventListener('click', function(){_this.runVKCode();});
        ...
        runVKCode : function() {
            try {
                _changeStatus(true);
                _createAndBuildProgram(this.vkCreateCode);
                // _runCode(this.vkCode);                
            } catch(e) {
                alert(e.message);
                this.stop();
            }
